...
//virtual Machine a big switch statement.

//Prepare_statement ("Our SQL Compiler").
...
int main(int argc, char const *argv[])
{
    ...
    //cout<<input_Buffer->buffer<<endl;
    //cout<<input_Buffer->buffer_length<<" "<<endl;
    //cout<<input_Buffer->input_length<<" ";
